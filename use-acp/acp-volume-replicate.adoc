...
.Cluster ONTAP
* *Astra Control Provisioner*: Astra Control Provisioner versione 23,10 o successiva o a link:../get-started/requirements.html["Astra Trident è supportato"] Deve esistere sui cluster Kubernetes di origine e di destinazione che utilizzano ONTAP come backend.
