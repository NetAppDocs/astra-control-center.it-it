...
+
** Per i cluster GKE, Astra Control Service utilizza  https://www.netapp.com/google-cloud/netapp-volumes/["NetApp Cloud Volumes Service per Google Cloud"^] o Google Persistent Disks come backend di archiviazione per i tuoi volumi persistenti.
** Per i cluster AKS, Astra Control Service utilizza  https://www.netapp.com/azure/azure-netapp-files/["Azure NetApp Files"^] o dischi gestiti da Azure come backend di archiviazione per i volumi persistenti.
