...
Astra Trident 22.10 o versione successiva installata e configurata e NetApp ONTAP versione 9.8 o successiva come backend di storage [[aws-registry]]
...
| Astra Trident (installato come parte del rilevamento dei cluster Kubernetes in NetApp BlueXP, in precedenza Cloud Manager)  a| 
Astra Trident 22.10 o versione successiva installata e configurata e NetApp ONTAP versione 9.8 o successiva come backend di storage [[gcp-registry]]
...
Astra Trident 22.10 o versione successiva installata e configurata e NetApp ONTAP versione 9.8 o successiva verrà utilizzato come backend di storage [[Azure-registry]]
