...
* link:../use/manage-apps.html#tech-preview-define-an-application-using-a-kubernetes-custom-resource["Definisci un'applicazione usando una risorsa personalizzata di Kubernetes"]
* link:../use/manage-buckets.html#tech-preview-manage-a-bucket-using-a-custom-resource["Gestire un bucket utilizzando una risorsa personalizzata"]
